...
| 9  | correct   | l'expression `cercle.coord` est utilisée pour initialiser `coord`                                                   |
| 10 | correct   | l'expression `cercle.coord` pointée par `ptr`est utilisée pour initialiser `coord`                                  |
