...
- ... copie de cet objets dans les éléments du vecteur => `CC(27a) CC(28a)`
...
- copie de `trace1a` dans les éléments du vecteur => `CC(29a) CC(30a)`
- sortie du bloc `{..}`, donc destruction des 2 objets => `D(30a) D(29a)`
